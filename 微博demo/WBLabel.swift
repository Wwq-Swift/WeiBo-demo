...
public class WBLabel: UILabel {
    //（R：193 G：210 B：240）
    public var linkTextColor = UIColor.init(red: 160/255, green: 160/255, blue: 255/255, alpha: 1.0)
    public var selectedBackgroudColor = UIColor.init(red: 193/255, green: 210/255, blue: 240/255, alpha: 0.8)
    public weak var labelDelegate: WBLabelDelegate?
    ...
    public override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        if selectedRange != nil {
            ...
            let when = DispatchTime.now() + .seconds(60)
